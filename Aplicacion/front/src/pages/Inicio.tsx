            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
                <div className="d-flex flex-column justify-content-center align-items-center text-center" style={{ minHeight: "80vh" }}>
                    ...
                    <p className="text-muted mb-4 w-75 mx-auto">
                        ...
                        que muestra información como estadísticas globales de los problemas y los usuarios. También incorpora un
                        sistema de logros que proporciona insignias a los usuarios para fidelizarlos con la plataforma.
                    </p>
                </div>
            </div>
        </>
