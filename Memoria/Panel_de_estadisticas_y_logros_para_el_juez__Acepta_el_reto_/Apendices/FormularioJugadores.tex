...
En este apéndice se muestran las preguntas propuestas en el formulario de estudio de los jugadores\footnote{Como se mencionó en el capítulo 4, en el contexto de la gamificación es más apropiado referirse a los usuarios como \textit{jugadores}} junto con las respuestas obtenidas. El formulario fue realizado y compartido como un documento \textit{Google Form} para el que no era necesario iniciar sesión o registrarse.
