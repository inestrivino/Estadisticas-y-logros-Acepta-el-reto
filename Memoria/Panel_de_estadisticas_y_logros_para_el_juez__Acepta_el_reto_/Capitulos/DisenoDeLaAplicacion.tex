...
En cuanto a los elementos de la interacción humano-máquina, tendremos en cuenta las heurísticas presentadas en \cite{Nielsen_1994}. En concreto para esta aplicación son importantes la visibilidad del estado del sistema, la equivalencia entre el sistema y el mundo real, y una representación de la información que simplifique el reconocimiento de los usuarios de la información, en vez de apelar a su memoria. 

Manteniendo las heurísticas en mente, debemos definir tanto las pantallas del sistema, como su colocación de elementos para facilitar el uso (UX). Para ello, se han realizado una serie de \textit{wireframes}, una por cada pantalla de la aplicación. Las pantallas de la aplicación son:
\begin{itemize}
    \item Inicio.
    \item Estadísticas de usuario.
    \begin{itemize}
        \item Estadísticas, cuyo \textit{wireframe} se encuentra en la figura \ref{fig:wireEstaUsuario}.
        \begin{figure}
            \centering
        ...
        \end{figure}
        \item Medallero, cuyo \textit{wireframe} se encuentra en la figura \ref{fig:wireMedaUsuario}.
        \begin{figure}
            \centering
        ...
        \end{figure}
    \end{itemize}
    \item Estadísticas de un problema, cuyo \textit{wireframe} se puede ver en la figura \ref{fig:wireEstaProblema}.
    \begin{figure}
        \centering
    ...
    \end{figure}
    \item Tabla de clasificación, cuyo \textit{wireframe} se puede ver en la figura \ref{fig:wireClasificacion}.
    \begin{figure}
        \centering
