...
\begin{itemize}
    ...
    \item Patrón Strategy o Specification en los actualizadores de estado, permitiendo intercambiar comportamientos específicos según el tipo de actualización.
\end{itemize}
