...
A lo largo de todo el proceso de desarrollo, se produce complementariamente la presente memoria del proyecto, tanto investigando, como escribiendo sobre nuestros resultados y experiencias.

Puede accederse al repositorio de Github donde se ha realizado el desarrollo colaborativo de la aplicación en el siguiente enlace:
\begin{center}
\url{https://github.com/inestrivino/Estadisticas-y-logros-Acepta-el-reto}
\end{center}.

Además, la aplicación web se encuentra desplegada con motivo del desarrollo (realización de pruebas, comprobación, etc), en el siguiente enlace:
\begin{center}
