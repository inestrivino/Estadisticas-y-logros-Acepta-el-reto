...
\ifpdf\hypersetup{%
    pdftitle = {\titulo},
    pdfsubject = {Memoria del TFG de creación de panel de estadísticas y logros para ¡Acepta el reto!},
    pdfkeywords = {juez, programación, estadísticas, gamifcación, visualización, logros, datos, web, react, node},
...
\include{Capitulos/EstadoDelArteDeJuecesEnLinea}
\include{Capitulos/EstadoDelArteDeTecnologias}
\include{Capitulos/DisenoDeLaAplicacion}
...
\begin{otherlanguage}{english}
\include{Capitulos/Inglés/Introduction}
\include{Capitulos/Inglés/ConclusionsFutureWork}
\end{otherlanguage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Apéndices
\appendix
\include{Apendices/SRS}
\include{Apendices/FormularioJugadores}
\backmatter
