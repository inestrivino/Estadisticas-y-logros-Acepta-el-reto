...
El producto se desarrolla en el marco de un Trabajo de Fin de Grado (TFG), bajo la supervisión de los creadores y mantenedores de \aer. Su objetivo es cubrir la necesidad de introducir mayor dinamismo y nuevas fuentes de motivación para los usuarios del juez \textit{online} mediante estadísticas detalladas y un sistema de logros.
...
\begin{itemize}
 ...
 Se seguirán principios de diseño responsivo y consistencia visual con el estilo general de \aer.
    \end{itemize}
