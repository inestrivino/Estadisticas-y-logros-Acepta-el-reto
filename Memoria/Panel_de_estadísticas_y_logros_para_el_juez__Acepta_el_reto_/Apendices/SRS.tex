...
Versión 0.1\\
Preparada por Inés Triviño Rello\\
...
El propósito del presente documento es servir como especificación de requisitos de software (SRS) para las funcionalidades de estadísticas y logros del juez online \textit{¡Acepta el reto!}. Este documento constituye la base para el diseño, desarrollo, validación y mantenimiento de dichas funcionalidades.

El documento está dirigido principalmente a los desarrolladores y mantenedores de las funcionalidades descritas, a los mantenedores del juez \textit{¡Acepta el reto!}, y a cualquier otra persona interesada en comprender el funcionamiento, alcance y limitaciones del producto.
...
\begin{itemize}
    ...
    \item \textbf{TFG}: Trabajo Fin de Grado.
    \item \textbf{¡Acepta el reto!}: Juez online de programación competitiva objeto de este proyecto.
\end{itemize}
...
El producto se desarrolla en el marco de un Trabajo de Fin de Grado (TFG), bajo la supervisión de los creadores y mantenedores de \textit{¡Acepta el reto!}. Su objetivo es cubrir la necesidad de introducir mayor dinamismo y nuevas fuentes de motivación para los usuarios del juez online mediante estadísticas detalladas y un sistema de logros.
...
El producto estará sujeto a limitaciones técnicas derivadas del stack tecnológico seleccionado durante el desarrollo del TFG, así como a restricciones de tiempo y recursos propios de un proyecto académico. Asimismo, el sistema dependerá de la disponibilidad y calidad de los datos proporcionados por el juez \textit{¡Acepta el reto!} u otras fuentes externas. No se contemplan requisitos específicos de hardware más allá de los necesarios para ejecutar una aplicación web moderna.
...
\begin{itemize}
 ...
 Se seguirán principios de diseño responsivo y consistencia visual con el estilo general de \textit{¡Acepta el reto!}.
    \end{itemize}

    \item \textbf{Interfaces software (API)}
 El sistema consumirá datos provenientes de las APIs del juez que proporcionen información sobre usuarios, envíos y ejercicios.
...
\begin{itemize}
    ...
    \item \textbf{Método de verificación:} Análisis.
\end{itemize}
