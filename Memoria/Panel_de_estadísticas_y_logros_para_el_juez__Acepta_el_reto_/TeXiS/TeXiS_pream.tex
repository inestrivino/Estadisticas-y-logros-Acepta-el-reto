...
% Cambio añadido para que "¡Acepta el Reto! siempre aparezca en cursiva, sin excepción
\usepackage{xspace}
% Comando para escribir ¡Acepta el reto! con itálica más rápido
\newcommand{\aer}{\textit{¡Acepta el reto!}\xspace}

% Cambio añadido para formatear las tablas más correctamente
\usepackage{booktabs}
