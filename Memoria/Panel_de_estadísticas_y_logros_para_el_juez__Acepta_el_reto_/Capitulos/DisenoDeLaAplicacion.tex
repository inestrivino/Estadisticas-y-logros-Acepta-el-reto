...
\begin{enumerate}
    ...
    \item En cuanto a la iconografía usaremos la versión más moderna de los iconos de Font Awesome\footnote{\url{https://fontawesome.com/icons}}, en específico los paquetes gratuitos con licencia CC-BY 4.0. \aer usa los iconos de Font Awesome en la versión 3.2.1\footnote{\url{https://fontawesome.com/v3/}}, sin embargo, esta versión ya no recibe soporte. De esta manera hemos optado por un balance entre la modernidad y usabilidad a largo plazo (garantizando soporte durante más tiempo), y la coherencia visual con \aer (ya que ambos paquetes de iconos son de la misma compañía y tienen fuertes similitudes). 
\end{enumerate}
